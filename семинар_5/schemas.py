...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Сравнить значение ОДНОЙ метрики в двух периодах. Сразу возвращает "
                "delta (b−a) и ratio (b/a) — отдельный calculate не нужен. Зови на "
                "вопросы вида «во сколько раз вырос курс…», «на сколько изменилась "
                "ставка/инфляция/безработица между датами»."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "period_a": {
                        "type": "string",
                        "description": "Первый период (раньше), 'YYYY-MM' или 'YYYY-MM-DD'.",
                    },
                    "period_b": {
                        "type": "string",
                        "description": "Второй период (позже), 'YYYY-MM' или 'YYYY-MM-DD'.",
                    },
                },
